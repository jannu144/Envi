  ...
  return (
    <>
      <div className="bg-light_green-50 flex sm:flex-col md:flex-col flex-row font-roundedmplusc gap-[37px] items-center mx-auto pl-[17px] w-full">
        ...
        <div className="h-[832px] sm:h-[908px] md:px-5 relative w-[81%] md:w-full">
          ...
          <div className="absolute h-[832px] sm:h-[908px] inset-[0] justify-center m-auto w-full">
            <div className="absolute bottom-[6%] flex flex-col font-roundedmplusc items-center justify-start left-[7%] w-[56%]">
              <div className="flex flex-col justify-start w-full">
                <div className="bg-teal-100 flex flex-col items-start justify-end md:ml-[0] ml-[321px] mr-[101px] p-0.5 rounded-[10px]">
                  <Text
                ...
                <div className="bg-blue_gray-100 flex flex-col font-roundedmplusc items-center justify-start md:ml-[0] ml-[273px] mt-[50px] p-4 rounded-[20px] w-[52%] md:w-full">
                  <div className="flex flex-col gap-[7px] justify-start w-[91%] md:w-full">
                    <Text
                    ...
                    <div className="flex flex-col gap-1.5 items-center justify-start w-full">
                      <div className="bg-pink-100 flex flex-col items-end justify-start p-[15px] rounded-[20px] w-full">
                        <div className="flex flex-col gap-[27px] justify-start mb-[47px] mr-1.5 w-[87%] md:w-full">
                          <Text
                            className="ml-4 md:ml-[0] text-base text-gray-800"
                          ...
                          <div className="flex flex-col gap-[25px] items-center justify-start w-full">
                            <div className="flex flex-row gap-[21px] items-center justify-between w-full">
                              ...
                              >
                                How many times did you use the train?
                              </Text>
                              <div className="bg-red-200 flex flex-col items-center justify-end my-2.5 p-[3px]">
                                <Text
                            ...
                            <div className="flex flex-row gap-8 items-center justify-between w-full">
                              ...
                              <div className="bg-red-200 flex flex-col items-center justify-end p-[3px]">
                                <Text
                                  className="text-[8px] text-black-900"
                                  size="txtRoundedMplus1cMedium8"
                                >
                      ...
                      <div className="flex flex-row items-center justify-between w-full">
                        <div className="bg-pink-100 flex flex-col items-end justify-start rounded-[9px]">
                          <Text
...
export default Transportation2Page;
