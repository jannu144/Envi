...
import { Img, Input, Line, Radio, SelectBox, Switch, Text } from "components";
        ...
        <div className="flex md:flex-col flex-row gap-[23px] items-start justify-between max-w-[1263px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col justify-start w-[84%] md:w-full">
            <div className="flex md:flex-col flex-row gap-[37px] items-center justify-between w-full">
              ...
              <div className="h-[832px] sm:h-[975px] relative w-[97%] md:w-full">
                <div className="absolute bottom-[6%] flex flex-col font-roundedmplusc items-center justify-start left-[0] w-[63%]">
                  <div className="flex flex-col items-center justify-start w-full">
                    <div className="flex sm:flex-col flex-row gap-2.5 items-center justify-center w-[69%] md:w-full">
                      <Text
                    ...
                    <div className="flex flex-col font-roboto items-center justify-start mt-[29px] w-[81%] md:w-full">
                      <div className="flex flex-col items-center justify-start w-full">
                    ...
                    <div className="flex md:flex-col flex-row font-roundedmplusc gap-[29px] items-start justify-between mt-[50px] w-full">
                      <div className="flex md:flex-1 flex-col gap-8 justify-start w-[51%] md:w-full">
                        <Input
                          name="month"
                        ...
                        ></Input>
                        <Text
                          className="ml-3 md:ml-[0] text-[15px] text-black-900"
                          size="txtRoundedMplus1cRegular15"
                        >
                          f
                        </Text>
                      </div>
                      <div className="bg-blue_gray-100 flex md:flex-1 flex-col items-end justify-end p-3.5 rounded-[20px] w-[46%] md:w-full">
                        <div className="flex flex-col gap-3 justify-start mr-[7px] mt-0.5 w-[90%] md:w-full">
                          <Text
                          ...
                          <div className="flex flex-col items-center justify-start w-full">
                            <div className="bg-lime-200 flex flex-col items-center justify-start pb-[68px] rounded-[20px] w-full">
                              <div className="flex flex-col gap-[11px] justify-start w-full">
                                <div className="bg-lime-200 flex flex-col items-center justify-end p-4 rounded-[20px] w-full">
                                  <div className="h-6 relative w-[53%]">
                                    <Text
                                      className="m-auto text-base text-gray-800"
                                      size="txtRoundedMplus1cRegular16"
                                    >
                                      General Waste
                                    </Text>
                                    <Text
                                      className="absolute h-full inset-[0] justify-center m-auto text-base text-gray-800 w-max"
                                      size="txtRoundedMplus1cRegular16"
                                    >
                                      General Waste
                                    </Text>
                                ...
                                <div className="flex flex-col gap-[37px] items-center justify-start ml-9 md:ml-[0] w-[77%] md:w-full">
                                  <div className="h-[21px] relative w-full">
                                    <Radio
                                      value="groupEightyNine"
                                      className="m-auto"
                                      inputClassName="absolute border border-lime-400 border-solid h-5 mr-[5px] rounded-[10px] w-5"
                                      checked={false}
                                      name="groupEightyNine"
                                      label="groupEightyNine"
                                      id="groupEightyNine"
                                    ></Radio>
                                    <div className="absolute bg-lime-400 flex flex-col h-max inset-y-[0] items-center justify-end my-auto p-0.5 right-[15%] w-[18px]">
                                      <Text
                                    ...
                                    <Radio
                                      value="groupNinetyOne"
                                      className="my-auto"
                                      inputClassName="absolute border border-lime-400 border-solid h-5 mr-[5px] rounded-[10px] w-5"
                                      checked={false}
                                      name="groupNinetyOne"
                                      label="groupNinetyOne"
                                      id="groupNinetyOne"
                                    ></Radio>
                                  </div>
                                  <div className="flex flex-row gap-8 items-center justify-between w-[99%] md:w-full">
                                    <Text
                            ...
                            <div className="flex flex-row items-center justify-between mt-[5px] w-full">
                              <div className="bg-lime-400 flex flex-col items-end justify-start rounded-[9px]">
                                <Text
